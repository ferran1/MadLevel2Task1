...
data class Place(
    var name: String,
    @DrawableRes var imageResId: Int // @DrawableRes indicates that android expects this variable to be a drawable Resource Id
) {
    // Companion object in kotlin is basically the same as static in Java (members inside the object can be called with the same syntax as static in Java)
    companion object {
